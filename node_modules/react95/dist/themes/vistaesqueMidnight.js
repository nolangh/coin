...
var vistaesqueMidnight = {
  ...
  headerBackground: 'linear-gradient(to right, rgb(81, 132, 188), rgb(100, 168, 60))',
  headerNotActiveBackground: 'linear-gradient(to right, rgb(22, 46, 101), rgb(18, 91, 30))',
...
module.exports = vistaesqueMidnight;
